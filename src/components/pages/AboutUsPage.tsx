  ...
  <div className="min-h-screen" style={{ backgroundColor: '#e9ecef' }}>
    <div className="container mx-auto px-6 pt-36 pb-12">
      ...
      <div className="h-screen flex items-center justify-center snap-start">
        <div className="w-full max-w-7xl px-6 md:px-8 lg:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          {/* Left: Video */}
          <div className="w-full lg:w-2/5 relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white" style={{ backgroundColor: '#1e1e1e' }}>
          ...
          {/* Right: Content */}
          <div className="w-full lg:w-3/5 bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border-4 border-white">
      ...
      <div className="h-screen flex items-center justify-center snap-start" style={{ backgroundColor: '#ffffff' }}>
        <div className="w-full max-w-7xl px-6 md:px-8 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">What We Offer</h2>
          </div>
      ...
      <div className="h-screen flex items-center justify-center snap-start" style={{ backgroundColor: '#e9ecef' }}>
        <div className="w-full max-w-7xl px-6 md:px-8 lg:px-12 space-y-8">
              ...
              <div className={`flex space-x-6 ${idxRow % 2 === 0 ? 'animate-slide' : 'animate-slide-reverse'}`}>
                {[...row, ...row].map((testimonial, idx) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 font-semibold text-sm">Student {idx + 1}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="h-screen flex items-center justify-center snap-start p-8" style={{ backgroundColor: '#e9ecef' }}>
        <div className="w-full max-w-6xl">
          <div className="rounded-3xl p-8 lg:p-12 shadow-2xl border-4 border-white bg-white">
            <div className="grid lg:grid-cols-5 gap-12">
              {/* Left Panel */}
              <div className="lg:col-span-2 flex flex-col justify-center space-y-8">
                <div className="space-y-4">
                  <h2 className="text-5xl lg:text-6xl font-black text-gray-900 leading-tight">Frequently</h2>
                  <h2 className="text-5xl lg:text-6xl font-black text-gray-900 leading-tight">Asked</h2>
                  <h2 className="text-5xl lg:text-6xl font-black text-gray-900 leading-tight">Questions</h2>
                </div>
              </div>

              {/* Right Panel */}
              <div className="lg:col-span-3 space-y-4 max-h-[500px] overflow-y-auto pr-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                  ...
                  >
                    <div className="p-6 flex justify-between items-start gap-4">
                      ...
                      <div className={`flex-shrink-0 transition-all duration-300 transform ${openFAQ === index ? 'rotate-45' : ''} w-8 h-8 rounded-lg flex items-center justify-center`}
                           style={{
                    ...
                    <div className={`overflow-hidden transition-all duration-500 ${openFAQ === index ? 'max-h-96 opacity-100 mt-4' : 'max-h-0 opacity-0'}`}>
